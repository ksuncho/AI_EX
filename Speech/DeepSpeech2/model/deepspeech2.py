...
class DeepSpeech2Model(nn.Module):
    ...
    def __init__(self,
        ...
        self.subsampling = ConvSubsampling4x2(feature_dim, out_dim=hidden_dim)
        self.rnn = GRUBody(num_layers, input_dim=self.subsampling.out_dim, hidden_dim=hidden_dim)
