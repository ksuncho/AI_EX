...
class GuideNN(nn.Module):
    def __init__(self, params=None):
        ...
        self.params = params
        self.conv1 = ConvBlock(3, 16, kernel_size=""" Practice Here """, padding=0, batch_norm=True)
        self.conv2 = ConvBlock(16, 1, kernel_size=""" Practice Here """, padding=0, activation=nn.Sigmoid) #nn.Tanh
...
class HDRPointwiseNN(nn.Module):
    ...
    def forward(self, lowres, fullres):
        coeffs = # Practice Here
        guide = # Practice Here
        slice_coeffs = # Practice Here
        out = # Practice Here
