...
if __name__ == '__main__':
    ...
    parser.add_argument('--abstract_pool_size', type=int, default=1)
    parser.add_argument('--pre_abstract_pool_size', type=int, default=1)
    ...
    parser.add_argument('--cl_coeff', type=float, default=1)
    ...
    parser.add_argument('--pre_model_root', type=str, default='model_illum')
    ...
    parser.add_argument('--ae_map_dir', type=str, default='ae_maps')
